...
slide("S28", "Keep Going", `${title("WANT TO KEEP GOING?", "배움을 계속 이어가고 싶다면?")}
  <div class="s5-cta"><div><h2>WSET BEER · LEVEL 1</h2><p>2026년 10월</p><p class="s5-benefit">폴리텍 수강생 혜택 <strong>10% 할인</strong></p><p class="s5-deadline">9/17 목요일 <strong>23:59까지</strong></p></div><div class="s5-qr-area"><img src="${asset("WSET_Beer_Level1_Qualification.jpg")}" alt="WSET Level 1 Award in Beer qualification"><div class="s5-qr-pending">신청 링크<br>준비 중</div></div></div>`, {cls:"s5-cta-slide"});
